...
use App\Http\Controllers\Admin\RandevuController;
...
Route::middleware('auth')->prefix('admin')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::prefix('randevu')->group(function () {
            ...
            Route::post('create', [\App\Http\Controllers\Admin\RandevuController::class, 'create'])->name('admin_randevu_add');
            Route::post('store/{id}', [\App\Http\Controllers\Admin\RandevuController::class, 'store'])->name('admin_randevu_store');
...
Route::middleware('auth')->prefix('user')->namespace('user')->group(function () {
    ...
    Route::prefix('randevu')->group(function (){
        Route::get('/',[\App\Http\Controllers\RandevuController::class,'index'])->name('user_randevu');
        Route::post('store/{id}/{slug}',[\App\Http\Controllers\RandevuController::class,'store'])->name('user_randevu_add');
        Route::post('update/{id}',[\App\Http\Controllers\RandevuController::class,'update'])->name('user_randevu_update');
        Route::get('delete/{id}',[\App\Http\Controllers\RandevuController::class,'destroy'])->name('user_randevu_delete');
        Route::get('show/{id}', [\App\Http\Controllers\RandevuController::class, 'show'])->name('user_randevu_show');
